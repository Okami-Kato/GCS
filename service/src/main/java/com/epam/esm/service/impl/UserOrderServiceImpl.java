...
public class UserOrderServiceImpl implements UserOrderService {
    ...
    @Autowired
    public UserOrderServiceImpl(ModelMapper mapper, UserOrderDao userOrderDao, CertificateDao certificateDao) {
        this.mapper = mapper;
     ...
     */
    @Override
    public Page<UserOrderItem> findAllByUserId(String userId, Pageable pageable) {
     ...
     */
    @Override
    public List<String> findUsersWithTheHighestCost() {
        return userOrderDao.findUsersWithTheHighestCost();
    }
